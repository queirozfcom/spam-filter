...
def case1():
    ...
    for i in xrange(NUMBER_OF_ROUNDS):
        ...
        for row in test_set:
            ...
            posterior_spam = prior_spam * stats.chi(sample_mean_word_spam, sample_std_dev_spam).pdf(row[CASE_1_ATTRIBUTE_INDEX])

            posterior_ham = prior_ham * stats.chi(sample_mean_word_ham, sample_std_dev_ham).pdf(row[CASE_1_ATTRIBUTE_INDEX])
    ...
    print ''
    print 'CASE 1 - ONE ATTRIBUTE ONLY - USING CHI MODEL'
